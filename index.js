...
artists[8].name = "Vincent van Dough"; /**i changed this but auto grader no like */
console.log(artists)
...
function getArtistByIndex(array, index) {
  let a = artists[index]
  return `the artist at index ${a.id} is ${a.name}`
}  
...
console.log(addArtist("20", "Alex", "1992-nov062020", "web design", "canadian", "i like computers. I like video games. I like frisbee golf."))
